...
namespace MyPoli.DataAccess.Migrations
{
    ...
    [Migration("20210910081032_add teacher and group to grades")]
    partial class addteacherandgrouptogrades
    {
            ...
            modelBuilder.Entity("MyPoli.Entities.Grade", b =>
                {
                    ...
                    b.HasIndex("IdSubject", "IdTeacher");
            ...
            modelBuilder.Entity("MyPoli.Entities.Grade", b =>
                {
                    ...
                    b.HasOne("MyPoli.Entities.SubjectTeacher", "SubjectTeacher")
                        .WithMany("Grades")
                        .HasForeignKey("IdSubject", "IdTeacher")
