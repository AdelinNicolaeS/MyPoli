...
namespace MyPoli.DataAccess.Migrations
{
    ...
    [Migration("20210809081110_add default data and user")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPoli.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "adelin.stanca@essensys.ro",
                            FirstName = "Stanca",
                            GenderId = (byte)1,
                            LastName = "Adelin",
                            PasswordHash = "123456",
            ...
            modelBuilder.Entity("MyPoli.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            UserId = new Guid("a2df34df-b17f-45cf-b233-feaf61cd2dac")
                        });
                });
            ...
            modelBuilder.Entity("MyPoli.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("MyPoli.Entities.User", "User")
                        .WithMany("UserRoles")
